...
// ഡെസ്ക്ടോപ്പ് സ്ക്രീനുകളിൽ മാത്രം ഫിഷ് കർസർ റൺ ചെയ്യാൻ (1024px-ന് മുകളിൽ)
if (window.innerWidth > 1024) {
    const fish = document.createElement('div');
    fish.id = 'fish-cursor';

    // ഒറിജിനൽ ഫിഷ് ഷേപ്പ് + പുതിയ കളർ തീം
    ...
    style.innerHTML = `
        #fish-cursor {
            ...
            pointer-events: none;
            z-index: 9999;
            /* മൗസ് പോയിന്റർ കൃത്യം മീനിന്റെ ചുണ്ടിൽ വരാൻ offset */
